...
const Index = () => {
    return (
        <div className="max-w-7xl mx-auto padding-y-xl max-xl:px-6">
            ...
            Level Up Your Halal Investing With Practical Tools
            </Typography>
            ...
            <div className='flex flex-col gap-[24px]'>
                ...
                <div className="grid xl:grid-cols-[576px_1fr] lg:grid-cols-[400px_1fr] sm:grid-cols-2  gap-[24px]">
                    ...
                    <div className="bg-primary-10 rounded-2xl shadow padding-lg flex flex-col border border-primary-30">
                        <div className="mb-6 lg:h-[250px] xl:h-[400px] md:h-[200px]"  >
                            <Image src={AppleCard} alt="AppleCard" className="w-full h-full" />
                        </div>

                        <Typography variant="displayMedium" className="mb-2 text-primary-50"  >Only invest in halal stock & crypto</Typography>
                    ...
                    <div className="bg-primary-10 rounded-2xl shadow padding-lg flex flex-col border border-primary-30">
                        ...
                        <Typography variant="displayMedium" className="mb-2 text-primary-50"  >Expertly-managed halal portfolios</Typography>
                        <Typography variant="bodyMediumR" className='text-neutral-100' >
                ...
                <div className="grid xl:grid-cols-[680px_1fr] lg:grid-cols-[580px_1fr] sm:grid-cols-2   gap-[24px]">
                    ...
                    <div className="bg-primary-10 rounded-2xl shadow padding-lg flex flex-col border border-primary-30">
                        ...
                        <Typography variant="displayMedium" className="mb-2 text-primary-50"  >Real-time buy and sell prices</Typography>
                        <Typography variant="bodyMediumR" className='text-neutral-100' >
                    ...
                    <div className="bg-primary-10 rounded-2xl shadow padding-lg flex flex-col border border-primary-30">
                        ...
                        <Typography variant="displayMedium" className="mb-2 text-primary-50"  >Reduce the stress of investing</Typography>
                        <Typography variant="bodyMediumR" className='text-neutral-100' >
            ...
            <div className="grid md:grid-cols-2 sm:grid-cols-2 gap-4 bg-primary-10 rounded-2xl shadow padding-lg flex flex-col border border-primary-30 mt-8">
                ...
                <div className="flex flex-col justify-center">
                    <Typography variant="displayMedium" className="mb-2 text-primary-50"  >Join an Exclusive Halal Investor Community</Typography>
                    <Typography variant="bodyMediumR" className='text-neutral-100' >
