...
const accordionData = [
    {
        ...
        content: "No. All investments carry risk. While PIF Invest uses research-backed, halal-conscious strategies, returns are not guaranteed and your capital is at risk."
    },
    {
        title: "Is PIF Invest available outside the United States?",
    ...
    {
        title: "Can I use my existing broker account with PIF Invest?",
    ...
    },
    {
        ...
        content: "Yes! Join our referral program to earn commissions by sharing PIF Invest with others. Login to your free account for more information."
    }
];
