...
export default function TermsConditionsPage() {
  ...
  const lastUpdated = 'March 04, 2022'
  ...
  const tableContent = {
    ...
    content: (
      <ol className="list-decimal pl-6 space-y-2">
        ...
        <li>
          <a href="#section17" className="text-neutral-100 hover:text-primary-50">
            MODIFICATIONS AND INTERRUPTIONS
          </a>
        </li>
        <li>
          <a href="#section18" className="text-neutral-100 hover:text-primary-50">
            GOVERNING LAW
          </a>
        </li>
        <li>
          <a href="#section19" className="text-neutral-100 hover:text-primary-50">
            DISPUTE RESOLUTION
          </a>
        </li>
        <li>
          <a href="#section20" className="text-neutral-100 hover:text-primary-50">
            CORRECTIONS
          </a>
        </li>
        <li>
          <a href="#section21" className="text-neutral-100 hover:text-primary-50">
            DISCLAIMER
          </a>
        </li>
        <li>
          <a href="#section22" className="text-neutral-100 hover:text-primary-50">
            LIMITATIONS OF LIABILITY
          </a>
        </li>
        <li>
          <a href="#section23" className="text-neutral-100 hover:text-primary-50">
            INDEMNIFICATION
          </a>
        </li>
        <li>
          <a href="#section24" className="text-neutral-100 hover:text-primary-50">
            USER DATA
          </a>
        </li>
        <li>
          <a href="#section25" className="text-neutral-100 hover:text-primary-50">
            ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
          </a>
        </li>
        <li>
          <a href="#section26" className="text-neutral-100 hover:text-primary-50">
            CALIFORNIA USERS AND RESIDENTS
          </a>
        </li>
        <li>
          <a href="#section27" className="text-neutral-100 hover:text-primary-50">
            MISCELLANEOUS
          </a>
        </li>
        <li>
          <a href="#section28" className="text-neutral-100 hover:text-primary-50">
            CONTACT US
          </a>
        </li>
      </ol>
  ...
  const section1 = {
    ...
    content: (
      <div className="space-y-4">  {/* Added wrapper div with space-y-4 */}
        <Typography variant="bodyMediumR" className="text-neutral-100">  {/* Removed mb-4 */}
          These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you") and Practical Finance LLC, doing business as Practical Islamic Finance ("Practical Islamic Finance," "we," "us," or "our"), concerning your access to and use of the https://practicalislamicfinance.com website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the "Site"). We are registered in Ohio, United States and have our registered office at 1985 W Henderson Rd PMB 3264, Columbus, OH 43220. You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
        </Typography>
    ...
    content: (
      <div className="space-y-4">
        <div>
          ...
          <ol className="list-decimal pl-6 space-y-2 text-neutral-100">
  ...
  const section11 = {
    title: '11. THIRD-PARTY WEBSITE AND CONTENT',
    content: (
      <div className="space-y-4">
        <Typography variant="bodyMediumR" className="text-neutral-100">
    ...
    content: (
      <div className="space-y-4">
        <Typography variant="bodyMediumR" className="text-neutral-100">
          ...
          <a 
            href="https://app.termly.io/document/privacy-policy/8eb0c06c-4371-4599-a0f1-5b399393702b" 
            className="text-primary-50 hover:underline"
            target="_blank"
            rel="noopener noreferrer"
          >
            https://app.termly.io/document/privacy-policy/8eb0c06c-4371-4599-a0f1-5b399393702b
          </a>
  ...
  const section15 = {
    title: '15. DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY',
    content: (
      <div className="space-y-4">
        <div>
          <Typography variant="bodyLargeM" className="text-neutral-100 mb-2">
            Notifications
          </Typography>
          <Typography variant="bodyMediumR" className="text-neutral-100">
        ...
        <div>
          ...
          <div className="text-neutral-100 space-y-1">
            <Typography variant="bodyMediumR">Rakaan Kayali</Typography>
            <Typography variant="bodyMediumR">Attn: Copyright Agent</Typography>
            <Typography variant="bodyMediumR">1985 W Henderson Rd PMB 3264</Typography>
            <Typography variant="bodyMediumR">Columbus, OH 43220</Typography>
            <Typography variant="bodyMediumR">United States</Typography>
            <Typography variant="bodyMediumR">practicalislamicfinance@gmail.com</Typography>
          </div>
        </div>
      </div>
    )
  ...
  const section28 = {
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="text-neutral-100 space-y-1">
          <Typography variant="bodyMediumR">Practical Finance LLC</Typography>
          <Typography variant="bodyMediumR">1985 W Henderson Rd PMB 3264</Typography>
          <Typography variant="bodyMediumR">Columbus, OH 43220</Typography>
          <Typography variant="bodyMediumR">United States</Typography>
  ...
  return (
    <div style={{ marginTop: 'var(--navbar-height)' }}>
      ...
      <div className="max-w-7xl mx-auto max-xl:px-6 padding-y-xl">
        ...
        <div className="space-y-10">  {/* Changed from flex and gap to space-y-10 */}

        <div id="tableOfContents" className="scroll-mt-20">
        ...
        <div id="section14" className="scroll-mt-20">
          <Typography variant="bodyXLargeSB" className="text-neutral-100 mb-6">
            {section14.title}
          </Typography>
          {section14.content}
        ...
        <div id="section17" className="scroll-mt-20">
          <Typography variant="bodyXLargeSB" className="text-neutral-100 mb-6">
            {section17.title}
          </Typography>
          {section17.content}
        ...
        <div id="section18" className="scroll-mt-20">
          <Typography variant="bodyXLargeSB" className="text-neutral-100 mb-6">
            {section18.title}
          </Typography>
          {section18.content}
        ...
        <div id="section19" className="scroll-mt-20">
          <Typography variant="bodyXLargeSB" className="text-neutral-100 mb-6">
            {section19.title}
          </Typography>
          {section19.content}
        ...
        <div id="section20" className="scroll-mt-20">
          <Typography variant="bodyXLargeSB" className="text-neutral-100 mb-6">
            {section20.title}
          </Typography>
          {section20.content}
        ...
        <div id="section21" className="scroll-mt-20">
          <Typography variant="bodyXLargeSB" className="text-neutral-100 mb-6">
            {section21.title}
          </Typography>
          {section21.content}
        ...
        <div id="section22" className="scroll-mt-20">
          <Typography variant="bodyXLargeSB" className="text-neutral-100 mb-6">
            {section22.title}
          </Typography>
          {section22.content}
        ...
        <div id="section23" className="scroll-mt-20">
          <Typography variant="bodyXLargeSB" className="text-neutral-100 mb-6">
            {section23.title}
          </Typography>
          {section23.content}
        ...
        <div id="section24" className="scroll-mt-20">
          <Typography variant="bodyXLargeSB" className="text-neutral-100 mb-6">
            {section24.title}
          </Typography>
          {section24.content}
        ...
        <div id="section25" className="scroll-mt-20">
          <Typography variant="bodyXLargeSB" className="text-neutral-100 mb-6">
            {section25.title}
          </Typography>
          {section25.content}
        ...
        <div id="section26" className="scroll-mt-20">
          <Typography variant="bodyXLargeSB" className="text-neutral-100 mb-6">
            {section26.title}
          </Typography>
          {section26.content}
        ...
        <div id="section27" className="scroll-mt-20">
          <Typography variant="bodyXLargeSB" className="text-neutral-100 mb-6">
            {section27.title}
          </Typography>
          {section27.content}
        ...
        <div id="section28" className="scroll-mt-20">
          <Typography variant="bodyXLargeSB" className="text-neutral-100 mb-6">
            {section28.title}
          </Typography>
          {section28.content}
