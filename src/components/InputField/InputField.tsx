   ...
   const formikTouched = formik?.touched[fieldName || '']
    ...
    return (
        ...
        <input
            ...
            className={`w-full rounded-full border border-neutral-30 py-2 px-4 bg-white focus:outline-none focus:border-primary-50 focus:[box-shadow:0_0_0_2px_#D6F1E7] disabled:bg-neutral-20 disabled:text-neutral-40 ${className}`}
            value={formikValues}
